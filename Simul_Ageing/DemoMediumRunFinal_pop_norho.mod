...
% This code produces the result for aging shock keeping population constant when demographic profiel does not influence innovation

var r, rk,  w, b,  y, varpi, s, inv,c, cw, cr, tauw, N, stoyw, PiF,Tw,  hw, Dr, Dw,  ep, varsig, zetar, zetay, gw, g, gE, iy, gpc, zz, far, faw, dr, dw,  mu, k, u, del, delprime, gM,   v, j,  lam, gA, za, PiA, PiRD,  fa, n , gn, gy, gamma, egamma, fert, psi, shockg;
varexo delg;
parameters SHINNOVW, YINNOVSH, FERTSS,  RHOYW, LAMY, PSISS, GSS, PERS, RATIODEL, OMEGAR, OMEGAY, RHOU, BBETA, ALPHA, GAMMAI, VARNU, BMEGA, CHI, RHO, PHI, ELASMU, ELASLAM, DELPRIMESS, DELSS, MUSS, LAMSS, USS, VARPISS, ZASS, KSS, NSS, GAMMASS, RHOE, CHIE;


load paramFinal_norho;
load vecSSFinal_norho;
load endpoint;
