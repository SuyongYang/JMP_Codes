...
% This code produces the result for aging shock keeping population constant
...
zz = OMEGAR + (1-OMEGAR)*ep(+1)^((RHOU-1)/RHOU); %9
...
delprime = DELPRIMESS + RATIODEL*DELPRIMESS*(u - USS)/USS; %26
