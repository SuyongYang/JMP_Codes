...
% This code produces the result for aging shock keeping population constant when age distribution of ideas changes

var r, rk,  w, b,  y, varpi, s, inv,c, cw, cr, tauw, N, stoyw, PiF,Tw,  hw, Dr, Dw,  ep, varsig, zetar, zetay, gw, g, gE, iy, gpc, zz, far, faw, dr, dw,  mu, k, u, del, delprime, gM,   v, j,  lam, gA, za, PiA, PiRD,  fa, n , gn, gy, gamma, egamma, fert, psi, shockg, rhoyw, shockrhoyw, erhoyw;
varexo delg;
parameters PERS2, SHINNOVW, YINNOVSH, FERTSS, DIFRHOYW,  RHOYW, LAMY, PSISS, GSS, PERS, RATIODEL, OMEGAR, OMEGAY, RHOU, BBETA, ALPHA, GAMMAI, VARNU, BMEGA, CHI, RHO, PHI, ELASMU, ELASLAM, DELPRIMESS, DELSS, MUSS, LAMSS, USS, VARPISS, ZASS, KSS, NSS, GAMMASS, RHOE, CHIE;
...
y = c + inv + s + varpi*(1-1/za(-1)) + tauw; %output identity
...
erhoyw = (PERS2)*erhoyw(-1) + shockrhoyw;
shockrhoyw = shockrhoyw(-1) + DIFRHOYW*delg/0.005;
