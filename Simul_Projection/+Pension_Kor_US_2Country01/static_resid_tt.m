...
T(28) = 1-1/y(47);
T(29) = params(176)/(y(72)*y(101))*y(97)/y(96);
T(30) = (1-params(176))*y(92)^((params(177)-1)/params(177));
T(31) = T(30)/(y(72)*y(101));
T(32) = y(97)/(y(96)*y(94));
T(33) = T(31)*T(32);
T(34) = y(131)+y(90)+y(72)*y(102)/y(97);
T(35) = 1/(1-params(177));
T(36) = (y(72)*params(178))^T(35);
T(37) = y(123)*T(36);
T(38) = (y(101)*y(72)*params(178))^T(35);
T(39) = (1+y(94)+y(95))^T(1);
T(40) = params(198)+params(199)/2*y(99)^2;
T(41) = y(93)^(T(1)/params(177));
T(42) = y(107)/y(97);
T(43) = y(115)^(1-params(181));
T(44) = y(111)^params(180);
T(45) = (y(96)*y(98))^((1-params(179))*(1-params(180)));
T(46) = y(85)^(-y(106));
T(47) = y(86)^params(170)*params(183);
T(48) = (y(78)/y(126))^params(184);
T(49) = 1-y(116)*params(185)/(y(115)*y(116));
T(50) = params(180)*(1-1/params(181))/y(106);
T(51) = y(97)/y(115);
T(52) = params(185)/y(72);
...
T(58) = (y(107)*y(97)*y(108)/(y(107)*y(108)))^(params(179)*(1-params(180)));
