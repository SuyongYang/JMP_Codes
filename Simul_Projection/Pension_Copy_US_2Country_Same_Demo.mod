...
Init_gdpratio=.5;
load paramFinal_ext1_US_Same_Demo;
load vecSSFinal_ext1_US_Same_Demo;
load paramFinal_ext1_US;
load vecSSFinal_ext1_US;
load endpoint;
load pred_param_2Country_US_Same_Demo;
...
zetar_star/(1+zetay_star+zetar_star)  = ZETARSS_star/(1+ZETAYSS_star+ZETARSS_star) + er; %share of retirees
%rstar = R_SS + shockR;
