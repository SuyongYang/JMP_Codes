...
options_ = [];
M_.fname = 'DemoMediumRunFinal_newpred_VNw';
...
diary off;
diary('DemoMediumRunFinal_newpred_VNw.log');
...
M_.endo_names(65) = {'AUX_ENDO_LAG_36_1'};
M_.endo_names_tex(65) = {'AUX\_ENDO\_LAG\_36\_1'};
M_.endo_names_long(65) = {'AUX_ENDO_LAG_36_1'};
M_.endo_names(66) = {'AUX_ENDO_LAG_45_1'};
M_.endo_names_tex(66) = {'AUX\_ENDO\_LAG\_45\_1'};
M_.endo_names_long(66) = {'AUX_ENDO_LAG_45_1'};
...
M_.mapping.w.eqidx = [1 17 19 20 50 ];
...
M_.mapping.tauw.eqidx = [2 19 47 50 ];
...
M_.mapping.varsig.eqidx = [5 6 7 8 17 ];
M_.mapping.zetar.eqidx = [3 4 10 11 14 15 55 56 57 58 ];
M_.mapping.zetay.eqidx = [10 11 12 13 15 16 17 30 55 56 57 58 ];
M_.mapping.gw.eqidx = [1 2 3 4 12 13 14 15 16 17 24 ];
M_.mapping.g.eqidx = [1 2 3 4 5 6 17 21 22 23 24 32 33 34 35 37 38 44 45 50 52 53 ];
M_.mapping.gE.eqidx = [16 24 ];
M_.mapping.iy.eqidx = [16 17 19 ];
...
M_.mapping.fert.eqidx = [18 ];
M_.mapping.omegay.eqidx = [12 16 17 18 30 ];
M_.mapping.shareW.eqidx = [55 ];
M_.mapping.shareR.eqidx = [56 ];
M_.mapping.delall.eqidx = [62 63 64 ];
M_.static_and_dynamic_models_differ = false;
M_.has_external_function = false;
M_.state_var = [1 4 5 6 7 15 16 24 25 26 27 28 32 33 36 37 38 45 46 49 51 58 59 60 65 66 67 68 69 70 71 72 73 74 75 76 77 78 79 80 81 82 83 84 85 86 87 88 89 90 91 92 93 94 95 96 97 98 99 100 101 102 103 104 105 106 107 108 109 110 111 112 113 114 115 116 117 118 119 120 121 122 123 ];
...
oo_.steady_state(40) = M_.params(25);
...
oo_.steady_state(65)=oo_.steady_state(37);
oo_.steady_state(66)=oo_.steady_state(46);
...
save CasePredM_ M_
save('DemoMediumRunFinal_newpred_VNw_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('DemoMediumRunFinal_newpred_VNw_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('DemoMediumRunFinal_newpred_VNw_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('DemoMediumRunFinal_newpred_VNw_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('DemoMediumRunFinal_newpred_VNw_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('DemoMediumRunFinal_newpred_VNw_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('DemoMediumRunFinal_newpred_VNw_results.mat', 'oo_recursive_', '-append');
end
