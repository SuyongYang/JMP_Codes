...
par = [bbeta ratiodel delta alpha rho varnu gammaI phi Bmega chi ratiodel elasmu rhoU gamma omegar omegay delprime el_SS chiE rhoE];
...
save paramFinal_ext1_US_Same_Demo gN_SS rhoyw bbeta ratiodel delta alpha rho varnu gammaI phi Bmega chi ratiodel elasmu phi rhoU gamma omegar omegay delprime el_SS chiE rhoE lamy yinnovsh etar deltaHE np shinnovw
save vecSSFinal_ext1_US_Same_Demo w_SS k_SS g_SS  gw_SS gE_SS iy_SS tauw_SS Tw_SS ga_SS c_SS y_SS mu_SS rk_SS  U_SS  R_SS lambda_SS el_SS  s_SS za_SS  v_SS  j_SS  varpi_SS b_SS fa_SS PiF_SS Z_SS Epvarsig_SS Ep_SS varsig_SS zetar_SS zetay_SS faw_SS far_SS cr_SS cw_SS hw_SS gm_SS gamma_SS n_SS Dr_SS Dw_SS dr_SS dw_SS PiA_SS inv_SS psi_SS stoyw_SS fert_SS replac_SS tauwA_SS tauwE_SS ay_SS tpe_SS Pe_SS he_SS
