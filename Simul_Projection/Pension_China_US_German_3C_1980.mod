...
var gdpratio    ${\mathfrak{G}}$ (long_name = 'Home GDP / Foreign GDP')
    gdpratio01  ${\mathfrak{G}}$ (long_name = 'Home GDP / Foreign GDP01')
    FB          ${\mathfrak{F}}$ ( long_name = 'Net foreign Bond of Home country / GDP')
    FB01          ${\mathfrak{F}}$ ( long_name = 'Net foreign Bond of Home country / GDP')
    FB02          ${\mathfrak{F}}$ ( long_name = 'Net foreign Bond of Home country / GDP')
    ...
    r_star01      ${r^*}$ ( long_name = 'foreign real interest rate')
    rk_star01     ${r^k^*}$ ( long_name = 'foreign capital rent')
    w_star01           ${w^*}$ ( long_name = 'labor income / GDP')
    b_star01           ${b^*}$ ( long_name = 'investment of R\&D and adoption / GDP')
    y_star01           ${y^*}$ ( long_name = 'disposible income / GDP')
    varpi_star01       ${\varpi^*}$ ( long_name = 'adoption investment X number of new ideas / GDP')
    s_star01           ${s^*}$ ( long_name = 'R\&D investment / GDP')
    inv_star01         ${i^*}$ ( long_name = 'fixed capital investment / GDP')
    invG_star01        ${g^i^*}$ ( long_name = 'fixed capital investment growth')
    c_star01           ${c^*}$ ( long_name = 'consumption / GDP')
    cw_star01          ${c^w^*}$ ( long_name = 'consumption of worker / GDP')
    cr_star01          ${c^r^*}$ ( long_name = 'consumption of retiree / GDP')
    tauw_star01        $\tilde{\tau}^*$ ( long_name = 'health care, pension, education cost / GDP')
    N_star01           ${N^f^*}$ ( long_name = 'number of input firms')
    stoyw_star01       ${\gamma^{yw}^*}$ ( long_name = 'share of R\&D worker')
    PiF_star01         ${\pi^F^*}$ ( long_name = 'profits of financial intermediary / GDP')
    Tw_star01          $\tilde{T}^w^*$ ( long_name = 'present value of education, health, pension / GDP')
    hw_star01          ${h^w^*}$ ( long_name = 'present value of workers labor income / GDP')
    Dr_star01          $\tilde{D}^r^*$ ( long_name = 'present value of retirees dividends / GDP')
    Dw_star01          $\tilde{D}^w^*$ ( long_name = 'present value of workers dividends / GDP')
    ep_star01          ${\epsilon^*}$ ( long_name = 'retiree MPC adjustment factor')
    varsig_star01      ${\varsigma^*}$ ( long_name = 'MPC of worker')
    zetar_star01       ${\zeta^r^*}$ ( long_name = 'retirees / workers')
    zetay_star01       ${\zeta^y^*}$ ( long_name = 'youth / workers')
    gw_star01          ${g^w^*}$ ( long_name = 'growth rate of workers')
    g_star01           ${g^*}$ ( long_name = 'growth rate of GDP')
    gE_star01          ${g^{\xi}^*}$ ( long_name = 'growth rate of average effective unit of labor')
    iy_star01          ${i^y^*}$ ( long_name = 'education investment / average effective unit of labor')
    gpc_star01         ${g_{dypc}^*}$ ( long_name = 'disposable income per capita growth')
    zz_star01          ${\mathfrak{Z}^*}$ ( long_name = 'local variable for symbolic briefness')
    far_star01         ${fa^r^*}$ ( long_name = 'financial assets of retirees / GDP')
    faw_star01         ${fa^w^*}$ ( long_name = 'financial assets of workers / GDP')
    dr_star01          $\tilde{d}^r^*$ ( long_name = 'dividends of retirees / GDP')
    dw_star01          $\tilde{d}^w^*$ ( long_name = 'dividends of workers / GDP')
    mu_star01          ${\mu^*}$ ( long_name = 'markup of input firms')
    k_star01           ${k^*}$ ( long_name = 'aggregate fixed capital / GDP')
    u_star01           ${u^*}$ ( long_name = 'capital utilization rate')
    del_star01         ${\delta^*}$ ( long_name = 'depreciation rate')
    delprime_star01    ${\delta^\prime^*}$ ( long_name = 'differentiation of depreciation rate')
    gM_star01          ${g^M^*}$ ( long_name = 'growth rate of aggregate intermediate composite goods')
    v_star01           ${v^*}$ ( long_name = 'aggregate value of adopted goods / GDP')
    j_star01           ${j^*}$ ( long_name = 'aggregate value of new ideas / GDP')
    lam_star01         ${\lambda^*}$ ( long_name = 'probability of success of adoption investment')
    gA_star01          ${g^A^*}$ ( long_name = 'growth rate of adopted goods')
    za_star01          ${z^a^*}$ ( long_name = 'number of aggregate new ideas / number of adopted goods')
    PiA_star01         ${\pi^A^*}$ ( long_name = 'profits for adpoters / GDP')
    PiRD_star01        ${\pi^{RD}^*}$ ( long_name = 'profits for R\&D sector')
    fa_star01          ${fa^*}$ ( long_name = 'aggregate financial assets / GDP')
    n_star01           ${n^*}$ ( long_name = 'growth rate of young population')
    gn_star01          ${g^n^*}$ ( long_name = 'growth rate of total population')
    gy_star01          ${g^y^*}$ ( long_name = 'growth rate of disposable income')
    gamma_star01       ${\gamma^*}$ ( long_name = 'probability of retiree survival rate')
    OMEGAY_star01      ${\omega^y^*}$ ( long_name = 'probability of staying young')
    fert_star01        ${fert^*}$ ( long_name = 'fertility')
    psi_star01         ${\psi^*}$ ( long_name = 'operation cost / GDP')
    tauwE_star01       $\tilde{\tau}^E^*$ ( long_name = 'education cost / GDP')
    tauwA_star01       $\tilde{\tau}^A^*$ ( long_name = 'pension and health care cost / GDP')
    ay_star01          ${ay^*}$ ( long_name = 'average labor income / GDP')
    tpe_star01         ${tpe^*}$ ( long_name = 'total payment of pensions / GDP')
    Pe_star01          ${Pe^*}$ ( long_name = 'present value of life long pension for retirees / GDP')
    he_star01          ${he^*}$ ( long_name = 'aggregate health expenditure / GDP')
    en_star01          ${en^*}$ ( long_name = 'population growth shock')
    ey_star01          ${ey^*}$ ( long_name = 'share of workers shock')
    er_star01          ${er^*}$ ( long_name = 'share of retirees shock')
    shockn_star01      ${shockn^*}$ ( long_name = 'sequence of population shocks')
    shocky_star01      ${shocky^*}$ ( long_name = 'sequence of share of workers shocks')
    shockr_star01      ${shockr^*}$ ( long_name = 'sequence of share of retirees shocks')
    shareW_star01      ${shareW^*}$ ( long_name = 'workers / population')
    shareR_star01      ${shareR^*}$ ( long_name = 'retirees / population')
;
...
Init_gdpratio01     ${\mathfrak{K}}$ ( long_name = 'steady state GDP ratio \: Home GDP / Foreign GDP ')
...
R_SS_star01           
ZETAYSS_star01        ${ZETAYSS^*}$ ( long_name = 'steady state of young / worker ')  
ZETARSS_star01        ${ZETARSS^*}$ ( long_name = 'steady state of retiree / worker ')
SHINNOVW_star01       ${SHINNOVW^*}$ ( long_name = 'share of innovation workers')
YINNOVSH_star01       ${\kappa^*}$ ( long_name = 'scale parameter to match new young innovators')
ETAR_star01           ${\eta^r^*}$ ( long_name = 'replacement ratio')
DELTAHE_star01        ${\delta_{HE}^*}$ ( long_name = 'share of health expenditure to GDP per capita')
NP_star01             ${n_p^*}$ ( long_name = 'average working years')
FERTSS_star01         ${FERTSS^*}$ ( long_name = 'steady state of fertility')
RHOYW_star01          ${\rho^{yw}^*}$ ( long_name = 'importance of young innovators in aggregate new ideas')
LAMY_star01           ${\lam^{yw}^*}$ ( long_name = 'rate of no longer active in innovation sector')
PSISS_star01          ${PSISS^*}$ ( long_name = 'steady state of operation cost')
GSS_star01            ${GSS^*}$ ( long_name = 'steady state of growth rate')
PERS_star01
RATIODEL_star01       ${\epsilon^{\delta^{\prime}}^*}$ ( long_name = 'elasticity of delta prime to capital utilization')
OMEGAR_star01         ${\omega^w^*}$ ( long_name = 'rate of staying workers')
RHOU_star01           ${\rho_U^*}$ ( long_name = 'preference parameter')
BBETA_star01          ${\beta^*}$ ( long_name = 'subjective discount factor')
ALPHA_star01          ${\alpha^*}$ ( long_name = 'fixed capital share of added value')
GAMMAI_star01         ${\gamma_I^*}$ ( long_name = 'intermediate good share')
VARNU_star01          ${\vartheta^*}$ ( long_name = 'markup of intermediate firms')
BMEGA_star01          ${BMEGA^*}$ ( long_name = 'scale parameter of operation cost')
CHI_star01            ${\chi^*}$ ( long_name = 'scale parameter in innovation process')
RHO_star01            ${\rho^*}$ ( long_name = 'R\&D elasticity of new technology creation in equilibrium')
PHI_star01            ${\phi^*}$ ( long_name = 'survival rate of new ideas or prototypes')
ELASMU_star01         ${\epsilon_{\mu}^*}$ ( long_name = 'elasticity of markup of input firms to number of input firms')
ELASLAM_star01        ${\epsilon_{\lambda}^*}$ ( long_name = 'elasticity of \lambda')
DELPRIMESS_star01     ${DELPRIMESS^*}$ ( long_name = 'steady state of \delta^{prime}')
DELSS_star01          ${DELSS^*}$ ( long_name = 'steady state of \delta')
MUSS_star01           ${MUSS^*}$ ( long_name = 'steady state of \mu')
LAMSS_star01          ${LAMSS^*}$ ( long_name = 'steady state of \lambda')
USS_star01            ${USS^*}$ ( long_name = 'steady state of capital utilization')
VARPISS_star01        ${VARPISS^*}$ ( long_name = 'steady state of \varpi')
ZASS_star01           ${ZASS^*}$ ( long_name = 'steady state of z_a')
KSS_star01            ${KSS^*}$ ( long_name = 'steady state of k')
NSS_star01            ${NSS^*}$ ( long_name = 'steady state of g^n')
GAMMASS_star01        ${GAMMASS^*}$ ( long_name = 'steady state of \gamma')
RHOE_star01           ${\rho_E^*}$ ( long_name = 'obsolescence of labor skills')
CHIE_star01           ${\chi_E^*}$ ( long_name = 'scale parameter in average effective units process')

gn_1_star01	gn_2_star01	gn_3_star01	gn_4_star01	gn_5_star01	gn_6_star01	gn_7_star01	gn_8_star01	gn_9_star01	gn_10_star01	gn_11_star01	gn_12_star01	gn_13_star01	gn_14_star01	gn_15_star01	gn_16_star01	gn_17_star01	gn_18_star01	gn_19_star01	gn_20_star01	gn_21_star01	gn_22_star01	gn_23_star01	gn_24_star01	gn_25_star01	gn_26_star01	gn_27_star01	gn_28_star01	gn_29_star01	gn_30_star01	gn_31_star01	gn_32_star01	gn_33_star01	gn_34_star01	gn_35_star01	gn_36_star01	gn_37_star01	gn_38_star01	gn_39_star01	gn_40_star01
dws_1_star01	dws_2_star01	dws_3_star01	dws_4_star01	dws_5_star01	dws_6_star01	dws_7_star01	dws_8_star01	dws_9_star01	dws_10_star01	dws_11_star01	dws_12_star01	dws_13_star01	dws_14_star01	dws_15_star01	dws_16_star01	dws_17_star01	dws_18_star01	dws_19_star01	dws_20_star01	dws_21_star01	dws_22_star01	dws_23_star01	dws_24_star01	dws_25_star01	dws_26_star01	dws_27_star01	dws_28_star01	dws_29_star01	dws_30_star01	dws_31_star01	dws_32_star01	dws_33_star01	dws_34_star01	dws_35_star01	dws_36_star01	dws_37_star01	dws_38_star01	dws_39_star01	dws_40_star01
drs_1_star01	drs_2_star01	drs_3_star01	drs_4_star01	drs_5_star01	drs_6_star01	drs_7_star01	drs_8_star01	drs_9_star01	drs_10_star01	drs_11_star01	drs_12_star01	drs_13_star01	drs_14_star01	drs_15_star01	drs_16_star01	drs_17_star01	drs_18_star01	drs_19_star01	drs_20_star01	drs_21_star01	drs_22_star01	drs_23_star01	drs_24_star01	drs_25_star01	drs_26_star01	drs_27_star01	drs_28_star01	drs_29_star01	drs_30_star01	drs_31_star01	drs_32_star01	drs_33_star01	drs_34_star01	drs_35_star01	drs_36_star01	drs_37_star01	drs_38_star01	drs_39_star01	drs_40_star01
...
%set_param_value('OMEGAY_star01',omegay_star01)
...
PiF = (rk + 1)*(k(-1)/g) + (b(-1)*r(-1)+FB(-1)*r_star(-1)+FB01(-1)*r_star01(-1))/g - fa(-1)*r(-1)/g - k - b - FB - FB01 + fa + (1-SHINNOVW)*(PiA + PiRD); %financial profits
...
r_star(1)-r_star01(1) = r_star-r_star01;
%r(1)-r_star01(1) = r-r_star01;


%market clearing conditions
k = (1-del)*(k(-1)/g) + inv; %evolution of investment 
y = (1-GAMMAI/(VARNU*mu)) - N*BMEGA*psi; %total output
FB + FB01 = y - ( c + inv + s + varpi*(1-1/za(-1)) + tauwE + he);
%current account
%y = c + inv + s + varpi*(1-1/za(-1)) + tauwE + he; %output identity
c = cr + cw; %total consumption
fa = k + b + FB + FB01 ; %asset markets clearing (financial assets of ertirees and workers is equalized to future loans and capital stock 
...
PiF_star = (rk_star + 1)*(k_star(-1)/g_star) + (b_star(-1)*r_star(-1) - gdpratio*FB(-1)*g(-1)/g_star(-1)*r_star(-1)+gdpratio*FB02(-1)*g(-1)/g_star(-1)*r_star01(-1))/g_star - fa_star(-1)*r_star(-1)/g_star - k_star - b_star + gdpratio*FB*g/g_star - gdpratio*FB02*g/g_star + fa_star + (1-SHINNOVW_star)*(PiA_star + PiRD_star); %financial profits
...
-gdpratio*FB*g/g_star + gdpratio*FB02*g/g_star = y_star -( c_star + inv_star + s_star + varpi_star*(1-1/za_star(-1)) + tauwE_star + he_star);
%current account : Note " - FB " here!!
%y = c + inv + s + varpi*(1-1/za(-1)) + tauwE + he; %output identity
c_star = cr_star + cw_star; %total consumption
fa_star = k_star + b_star - gdpratio*FB*g/g_star + gdpratio*FB02*g/g_star ; %asset markets clearing (financial assets of ertirees and workers is equalized to future loans and capital stock 
% " -FB " here!!
...
%households
hw_star01 = w_star01 + (OMEGAR_star01/(r_star01*zz_star01))*(g_star01(+1)/gw_star01)*hw_star01(+1); %present value of gains from human capital (workers)
Tw_star01 = tauw_star01 + (OMEGAR_star01/(r_star01*zz_star01))*(g_star01(+1)/gw_star01)*Tw_star01(+1); %present value of transfers (workers)
Dr_star01 = dr_star01 + Dr_star01(+1)*gamma_star01*g_star01(+1)*zetar_star01(-1)/(r_star01*zetar_star01*gw_star01); %dividends to retirees from financial profits
ay_star01 = (1/NP_star01)*(w_star01(-1)*(1-OMEGAR_star01)) + (1-1/NP_star01)*ay_star01(-1)*gw_star01(-2)/g_star01; %average labour income -earning reference for pensions
tpe_star01 = ETAR_star01*ay_star01+ gamma_star01(-1)*(gE_star01(-1)/g_star01)*tpe_star01(-1); %total pension - newly + pensions of retirees who did so in previous periods
Pe_star01 = tpe_star01 + Pe_star01(+1)*gamma_star01*g_star01(+1)*zetar_star01(-1)/(r_star01*zetar_star01*gw_star01); %Present value of pension
Dw_star01 = dw_star01 + (OMEGAR_star01/(r_star01*zz_star01))*(g_star01(+1)/gw_star01)*Dw_star01(+1) + (((1-OMEGAR_star01)*ep_star01(+1)^((RHOU_star01-1)/RHOU_star01))/(r_star01*zz_star01))*(g_star01(+1)/(zetar_star01*gw_star01))*(Dr_star01(+1)+Pe_star01(+1)); %dividends to workers
cw_star01 = varsig_star01*(r_star01(-1)*faw_star01(-1)/g_star01 + hw_star01 + Dw_star01 - Tw_star01); %consumption of workers
cr_star01 = ep_star01*varsig_star01*(r_star01(-1)*far_star01(-1)/g_star01 + Dr_star01 + Pe_star01); %consumption of retirees
1- ep_star01*varsig_star01 = ((BBETA_star01*r_star01)^(1/(1-RHOU_star01))*gamma_star01/r_star01)*(ep_star01*varsig_star01/(ep_star01(+1)*varsig_star01(+1))); 
1- varsig_star01 = ((BBETA_star01*r_star01*zz_star01)^(1/(1-RHOU_star01))/(r_star01*zz_star01))*(varsig_star01/varsig_star01(+1));
zz_star01 = OMEGAR_star01 + (1-OMEGAR_star01)*ep_star01(+1)^((RHOU_star01-1)/RHOU_star01);
he_star01 = DELTAHE_star01*(zetar_star01(-1)/(1+zetar_star01(-1)+zetay_star01(-1)));
tauwA_star01 = tpe_star01 + he_star01;
tauwE_star01 = iy_star01*w_star01;
tauw_star01 = tauwE_star01 + tauwA_star01;

%population dynamics
gw_star01 = OMEGAR_star01 + (1-OMEGAY_star01)*zetay_star01(-1);
n_star01 = zetay_star01/zetay_star01(-1)*gw_star01; %evolution of worker population
gw_star01*zetar_star01 = (1-OMEGAR_star01) + gamma_star01*zetar_star01(-1); %evolution of retirees population
gn_star01 = (n_star01*zetay_star01(-1) + gw_star01 + gw_star01*zetar_star01)*(1+zetar_star01(-1)+zetay_star01(-1))^(-1); %evolution of population
gE_star01 = (OMEGAR_star01 + (1-OMEGAY_star01)*zetay_star01(-1)*(RHOE_star01 + CHIE_star01/2*iy_star01^2))/gw_star01;
varsig_star01^(-1/RHOU_star01) = varsig_star01(+1)^(-1/RHOU_star01)*BBETA_star01*(1-OMEGAY_star01)*zetay_star01(-1)*CHIE_star01*iy_star01*w_star01(+1)*g_star01(+1)/(w_star01*gw_star01); %investment in labour skills
fert_star01 = n_star01 - OMEGAY_star01;

%production
(1-ALPHA_star01)*(1-GAMMAI_star01) = mu_star01*w_star01; %eq'm wage
ALPHA_star01*(1-GAMMAI_star01) = mu_star01*(rk_star01 + del_star01)*(k_star01(-1)/g_star01); %rent of capital
ALPHA_star01*(1-GAMMAI_star01) = mu_star01*delprime_star01*(k_star01(-1)/g_star01)*(u_star01); %utilization rate
g_star01 = (mu_star01/mu_star01(-1))*gM_star01*(gA_star01(-1))^(1-VARNU_star01); 
g_star01 = (N_star01^(mu_star01-1))/(N_star01(-1)^(mu_star01(-1)-1))*(g_star01(-1)*u_star01*(k_star01(-1))/(u_star01(-1)*k_star01(-2)))^(ALPHA_star01*(1-GAMMAI_star01))*((gE_star01(-1)*gw_star01(-1))^((1-ALPHA_star01)*(1-GAMMAI_star01)))*(gM_star01)^GAMMAI_star01;
((mu_star01-1)/mu_star01)*(N_star01^(-mu_star01)) = BMEGA_star01*v_star01; %number of firms
mu_star01 = MUSS_star01*(1+ ELASMU_star01*(N_star01 - 1)); %mark-up
del_star01  = DELSS_star01 + delprime_star01*(u_star01 - USS_star01); %depreciation rate
delprime_star01 = DELPRIMESS_star01 + RATIODEL_star01*DELPRIMESS_star01*(u_star01 - USS_star01)/USS_star01;
invG_star01 = inv_star01/inv_star01(-1)*g_star01;

%innovators/adoptors
gA_star01*za_star01/za_star01(-1) = (stoyw_star01)^(RHOYW_star01)*CHI_star01*(s_star01/psi_star01)^RHO_star01 + PHI_star01; %evolution of invented goods
stoyw_star01 = YINNOVSH_star01*(1-OMEGAY_star01)*zetay_star01(-1)/(1+zetay_star01(-1)+zetar_star01(-1)) + ((1-LAMY_star01)*OMEGAR_star01/gn_star01(-1))*stoyw_star01(-1); % intensity to transform invented goods into adopted goods
gA_star01 = lam_star01*PHI_star01*(za_star01(-1)-1)+PHI_star01; % evolution of adopted goods
s_star01 = (g_star01(+1)/r_star01)*PHI_star01*j_star01(+1)*(1 - PHI_star01*za_star01(-1)/(za_star01*gA_star01)); %investment in r and d
v_star01 = (1-1/VARNU_star01)*GAMMAI_star01/mu_star01 + (g_star01(+1)/gA_star01)*(PHI_star01/r_star01)*v_star01(+1);
varpi_star01 = ELASLAM_star01*lam_star01*za_star01(-1)*(g_star01(+1)/gA_star01)*(PHI_star01/r_star01)*(v_star01(+1) - j_star01(+1)/za_star01); %investment in adoption
j_star01= -varpi_star01 + za_star01(-1)*(g_star01(+1)/gA_star01)*(PHI_star01/r_star01)*(lam_star01*v_star01(+1) + (1-lam_star01)*j_star01(+1)/za_star01);
lam_star01 = LAMSS_star01*(1+ELASLAM_star01*((varpi_star01 - VARPISS_star01)/VARPISS_star01  - (za_star01(-1) - ZASS_star01)/ZASS_star01 - (psi_star01 - PSISS_star01)/PSISS_star01));
PiA_star01 = (1-1/VARNU_star01)*GAMMAI_star01/mu_star01 -  PHI_star01*j_star01*(1 - PHI_star01*za_star01(-2)/(za_star01(-1)*gA_star01(-1))) - r_star01(-1)*varpi_star01(-1)*(1 -1/za_star01(-2))/g_star01; %profits from adoption
PiRD_star01 = PHI_star01*j_star01*(1 - PHI_star01*za_star01(-2)/(za_star01(-1)*gA_star01(-1))) - r_star01(-1)*s_star01(-1)/g_star01; %profits from invention
psi_star01 = v_star01;

%financial intermediary
r_star01 = (rk_star01(+1)+1); %ex ante rate of return
dr_star01 = PiF_star01*far_star01(-1)/fa_star01(-1); %financial dividends to retirees
dw_star01 = PiF_star01*faw_star01(-1)/fa_star01(-1) + SHINNOVW_star01*(PiA_star01 + PiRD_star01); %financial dividends to workers
b_star01 = s_star01 +  varpi_star01*(1 -1/za_star01(-1)) ; %total bank loans
PiF_star01 = (rk_star01 + 1)*(k_star01(-1)/g_star01) + (b_star01(-1)*r_star01(-1)-gdpratio01*FB01(-1)*g(-1)/g_star01(-1)*r_star01(-1) - gdpratio01*FB02(-1)*g(-1)/g_star01(-1)*r_star01(-1))/g_star01 - fa_star01(-1)*r_star01(-1)/g_star01 - k_star01 - b_star01 + gdpratio01*FB01*g/g_star01  + gdpratio01*FB02*g/g_star01 + fa_star01 + (1-SHINNOVW_star01)*(PiA_star01 + PiRD_star01); %financial profits



%market clearing conditions
k_star01 = (1-del_star01)*(k_star01(-1)/g_star01) + inv_star01; %evolution of investment 
y_star01 = (1-GAMMAI_star01/(VARNU_star01*mu_star01)) - N_star01*BMEGA_star01*psi_star01; %total output
gdpratio01 = Init_gdpratio01*(delall 
+ g(-1)/g_star01(-1)*delall(-1)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*delall(-2)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*delall(-3)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*delall(-4)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*delall(-5)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*delall(-6)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*delall(-7)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*delall(-8)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*delall(-9)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*delall(-10)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*delall(-11)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*delall(-12)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*delall(-13)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*delall(-14)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*delall(-15)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*delall(-16)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*delall(-17)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*delall(-18)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*delall(-19)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*delall(-20)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*delall(-21)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*delall(-22)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*delall(-23)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*delall(-24)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*delall(-25)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*delall(-26)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*delall(-27)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*delall(-28)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*delall(-29)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*delall(-30)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*g(-31)/g_star01(-31)*delall(-31)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*g(-31)/g_star01(-31)*g(-32)/g_star01(-32)*delall(-32)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*g(-31)/g_star01(-31)*g(-32)/g_star01(-32)*g(-33)/g_star01(-33)*delall(-33)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*g(-31)/g_star01(-31)*g(-32)/g_star01(-32)*g(-33)/g_star01(-33)*g(-34)/g_star01(-34)*delall(-34)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*g(-31)/g_star01(-31)*g(-32)/g_star01(-32)*g(-33)/g_star01(-33)*g(-34)/g_star01(-34)*g(-35)/g_star01(-35)*delall(-35)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*g(-31)/g_star01(-31)*g(-32)/g_star01(-32)*g(-33)/g_star01(-33)*g(-34)/g_star01(-34)*g(-35)/g_star01(-35)*g(-36)/g_star01(-36)*delall(-36)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*g(-31)/g_star01(-31)*g(-32)/g_star01(-32)*g(-33)/g_star01(-33)*g(-34)/g_star01(-34)*g(-35)/g_star01(-35)*g(-36)/g_star01(-36)*g(-37)/g_star01(-37)*delall(-37)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*g(-31)/g_star01(-31)*g(-32)/g_star01(-32)*g(-33)/g_star01(-33)*g(-34)/g_star01(-34)*g(-35)/g_star01(-35)*g(-36)/g_star01(-36)*g(-37)/g_star01(-37)*g(-38)/g_star01(-38)*delall(-38)
+ g(-1)/g_star01(-1)*g(-2)/g_star01(-2)*g(-3)/g_star01(-3)*g(-4)/g_star01(-4)*g(-5)/g_star01(-5)*g(-6)/g_star01(-6)*g(-7)/g_star01(-7)*g(-8)/g_star01(-8)*g(-9)/g_star01(-9)*g(-10)/g_star01(-10)*g(-11)/g_star01(-11)*g(-12)/g_star01(-12)*g(-13)/g_star01(-13)*g(-14)/g_star01(-14)*g(-15)/g_star01(-15)*g(-16)/g_star01(-16)*g(-17)/g_star01(-17)*g(-18)/g_star01(-18)*g(-19)/g_star01(-19)*g(-20)/g_star01(-20)*g(-21)/g_star01(-21)*g(-22)/g_star01(-22)*g(-23)/g_star01(-23)*g(-24)/g_star01(-24)*g(-25)/g_star01(-25)*g(-26)/g_star01(-26)*g(-27)/g_star01(-27)*g(-28)/g_star01(-28)*g(-29)/g_star01(-29)*g(-30)/g_star01(-30)*g(-31)/g_star01(-31)*g(-32)/g_star01(-32)*g(-33)/g_star01(-33)*g(-34)/g_star01(-34)*g(-35)/g_star01(-35)*g(-36)/g_star01(-36)*g(-37)/g_star01(-37)*g(-38)/g_star01(-38)*g(-39)/g_star01(-39)*delall(-39) );


-gdpratio01*FB01*g/g_star01 -gdpratio01*FB02*g/g_star01 = y_star01 -( c_star01 + inv_star01 + s_star01 + varpi_star01*(1-1/za_star01(-1)) + tauwE_star01 + he_star01);
%current account : Note " - FB " here!!
%y = c + inv + s + varpi*(1-1/za(-1)) + tauwE + he; %output identity
c_star01 = cr_star01 + cw_star01; %total consumption
fa_star01 = k_star01 + b_star01 - gdpratio01*FB01*g/g_star01 - gdpratio01*FB02*g/g_star01 ; %asset markets clearing (financial assets of ertirees and workers is equalized to future loans and capital stock 
% " -FB " here!!
far_star01 = far_star01(-1)*r_star01(-1)/g_star01 + dr_star01 + tpe_star01 - cr_star01 + (1-OMEGAR_star01)*(faw_star01(-1)*r_star01(-1)/g_star01 +w_star01+dw_star01-cw_star01 - tauw_star01) ; %flow of assets
fa_star01  = far_star01+faw_star01; %financial assets


%exogenous variables
gpc_star01 = (y_star01/y_star01(-1))*g_star01(-1)/gn_star01(-1);
gy_star01 = (y_star01/y_star01(-1))*g_star01;
%/g???
gn_star01 = NSS_star01 + en_star01; %population growth 
shareW_star01 = 1/(1+zetay_star01+zetar_star01);
shareR_star01 = zetar_star01/(1+zetay_star01+zetar_star01);
1/(1+zetay_star01+zetar_star01)  = 1/(1+ZETAYSS_star01+ZETARSS_star01) + ey_star01; %share of workers in pop
zetar_star01/(1+zetay_star01+zetar_star01)  = ZETARSS_star01/(1+ZETAYSS_star01+ZETARSS_star01) + er_star01; %share of retirees
%rstar = R_SS + shockR;
%rstar=R_SS/1.01+shockR;
...
en_star01 = shockn_star01*(gn_1_star01-NSS_star01) +shockn_star01(-1)*(gn_2_star01-NSS_star01)+shockn_star01(-2)*(gn_3_star01-NSS_star01)+shockn_star01(-3)*(gn_4_star01-NSS_star01)+shockn_star01(-4)*(gn_5_star01-NSS_star01)+shockn_star01(-5)*(gn_6_star01-NSS_star01)+shockn_star01(-6)*(gn_7_star01-NSS_star01)+shockn_star01(-7)*(gn_8_star01-NSS_star01)+shockn_star01(-8)*(gn_9_star01-NSS_star01)+shockn_star01(-9)*(gn_10_star01-NSS_star01)+shockn_star01(-10)*(gn_11_star01-NSS_star01)+shockn_star01(-11)*(gn_12_star01-NSS_star01)+shockn_star01(-12)*(gn_13_star01-NSS_star01)+shockn_star01(-13)*(gn_14_star01-NSS_star01)+shockn_star01(-14)*(gn_15_star01-NSS_star01)+shockn_star01(-15)*(gn_16_star01-NSS_star01)+shockn_star01(-16)*(gn_17_star01-NSS_star01)+shockn_star01(-17)*(gn_18_star01-NSS_star01)+shockn_star01(-18)*(gn_19_star01-NSS_star01)+shockn_star01(-19)*(gn_20_star01-NSS_star01)+shockn_star01(-20)*(gn_21_star01-NSS_star01)+shockn_star01(-21)*(gn_22_star01-NSS_star01)+shockn_star01(-22)*(gn_23_star01-NSS_star01)+shockn_star01(-23)*(gn_24_star01-NSS_star01)+shockn_star01(-24)*(gn_25_star01-NSS_star01)+shockn_star01(-25)*(gn_26_star01-NSS_star01)+shockn_star01(-26)*(gn_27_star01-NSS_star01)+shockn_star01(-27)*(gn_28_star01-NSS_star01)+shockn_star01(-28)*(gn_29_star01-NSS_star01)+shockn_star01(-29)*(gn_30_star01-NSS_star01)+shockn_star01(-30)*(gn_31_star01-NSS_star01)+shockn_star01(-31)*(gn_32_star01-NSS_star01)+shockn_star01(-32)*(gn_33_star01-NSS_star01)+shockn_star01(-33)*(gn_34_star01-NSS_star01)+shockn_star01(-34)*(gn_35_star01-NSS_star01)+shockn_star01(-35)*(gn_36_star01-NSS_star01)+shockn_star01(-36)*(gn_37_star01-NSS_star01)+shockn_star01(-37)*(gn_38_star01-NSS_star01)+shockn_star01(-38)*(gn_39_star01-NSS_star01)+shockn_star01(-39)*(gn_40_star01-NSS_star01);
er_star01 = shockr_star01;
ey_star01 = shocky_star01;
shocky_star01 = shocky_star01(-1) + delall*dws_1_star01 + delall(-1)*dws_2_star01+delall(-2)*dws_3_star01+delall(-3)*dws_4_star01+delall(-4)*dws_5_star01+delall(-5)*dws_6_star01+delall(-6)*dws_7_star01+delall(-7)*dws_8_star01+delall(-8)*dws_9_star01+delall(-9)*dws_10_star01+delall(-10)*dws_11_star01+delall(-11)*dws_12_star01+delall(-12)*dws_13_star01+delall(-13)*dws_14_star01+delall(-14)*dws_15_star01+delall(-15)*dws_16_star01+delall(-16)*dws_17_star01+delall(-17)*dws_18_star01+delall(-18)*dws_19_star01+delall(-19)*dws_20_star01+delall(-20)*dws_21_star01+delall(-21)*dws_22_star01+delall(-22)*dws_23_star01+delall(-23)*dws_24_star01+delall(-24)*dws_25_star01+delall(-25)*dws_26_star01+delall(-26)*dws_27_star01+delall(-27)*dws_28_star01+delall(-28)*dws_29_star01+delall(-29)*dws_30_star01+delall(-30)*dws_31_star01+delall(-31)*dws_32_star01+delall(-32)*dws_33_star01+delall(-33)*dws_34_star01+delall(-34)*dws_35_star01+delall(-35)*dws_36_star01+delall(-36)*dws_37_star01+delall(-37)*dws_38_star01+delall(-38)*dws_39_star01+delall(-39)*dws_40_star01; 
shockr_star01 = shockr_star01(-1) + delall*dws_1_star01 + delall(-1)*drs_2_star01+delall(-2)*drs_3_star01+delall(-3)*drs_4_star01+delall(-4)*drs_5_star01+delall(-5)*drs_6_star01+delall(-6)*drs_7_star01+delall(-7)*drs_8_star01+delall(-8)*drs_9_star01+delall(-9)*drs_10_star01+delall(-10)*drs_11_star01+delall(-11)*drs_12_star01+delall(-12)*drs_13_star01+delall(-13)*drs_14_star01+delall(-14)*drs_15_star01+delall(-15)*drs_16_star01+delall(-16)*drs_17_star01+delall(-17)*drs_18_star01+delall(-18)*drs_19_star01+delall(-19)*drs_20_star01+delall(-20)*drs_21_star01+delall(-21)*drs_22_star01+delall(-22)*drs_23_star01+delall(-23)*drs_24_star01+delall(-24)*drs_25_star01+delall(-25)*drs_26_star01+delall(-26)*drs_27_star01+delall(-27)*drs_28_star01+delall(-28)*drs_29_star01+delall(-29)*drs_30_star01+delall(-30)*drs_31_star01+delall(-31)*drs_32_star01+delall(-32)*drs_33_star01+delall(-33)*drs_34_star01+delall(-34)*drs_35_star01+delall(-35)*drs_36_star01+delall(-36)*drs_37_star01+delall(-37)*drs_38_star01+delall(-38)*drs_39_star01+delall(-39)*drs_40_star01;  
shockn_star01 = delall;
...
r_star01= R_SS_star01;
gy_star01 = g_SS_star01;
tauwA_star01 = tauwA_SS_star01;
tauwE_star01 = tauwE_SS_star01;
tpe_star01 = tpe_SS_star01;
he_star01 = he_SS_star01;
ay_star01 = ay_SS_star01;
Pe_star01 = Pe_SS_star01;
Tw_star01 = Tw_SS_star01;
tauw_star01 = tauw_SS_star01;
hw_star01 = hw_SS_star01;
Dr_star01 = Dr_SS_star01;
Dw_star01 = Dw_SS_star01;
cw_star01 = cw_SS_star01;
cr_star01 = cr_SS_star01;
ep_star01 = Ep_SS_star01;
varsig_star01 = varsig_SS_star01;
zetar_star01 = zetar_SS_star01;
zetay_star01 = zetay_SS_star01;
g_star01 = g_SS_star01;
gw_star01 = gw_SS_star01;
zz_star01 = Z_SS_star01;
far_star01 = far_SS_star01;
faw_star01 = faw_SS_star01;
dr_star01 = dr_SS_star01;
dw_star01 = dw_SS_star01;
w_star01 = w_SS_star01;
mu_star01 = mu_SS_star01;
k_star01 = k_SS_star01;
u_star01 = U_SS_star01;
del_star01  = delta_star01;
delprime_star01 = DELPRIMESS_star01;
invG_star01 = g_SS_star01;
gM_star01 = gm_SS_star01;
N_star01 = 1;
rk_star01 = rk_SS_star01;
s_star01 = s_SS_star01;
v_star01 = v_SS_star01;
j_star01 = j_SS_star01;
varpi_star01 = varpi_SS_star01;
lam_star01 =  lambda_SS_star01;
gA_star01 = ga_SS_star01;
gE_star01 = gE_SS_star01;
iy_star01 = iy_SS_star01;
za_star01 = za_SS_star01;
PiA_star01 = PiA_SS_star01; 
PiRD_star01 = 0;
psi_star01 = psi_SS_star01;
b_star01 = b_SS_star01;
PiF_star01 = PiF_SS_star01;
y_star01 = y_SS_star01;
c_star01 = c_SS_star01;
inv_star01 = inv_SS_star01;
fa_star01 = fa_SS_star01;
n_star01 = n_SS_star01;
gn_star01 = n_SS_star01;
gamma_star01 = gamma_SS_star01;
gpc_star01 = g_SS_star01/n_SS_star01;
stoyw_star01 = stoyw_SS_star01;
en_star01 = 0;
fert_star01 = fert_SS_star01;
OMEGAY_star01 = omegay_star01;
shareW_star01 = 1/(1+ZETARSS_star01+ZETAYSS_star01);
shareR_star01 =  ZETARSS_star01/(1+ZETARSS_star01+ZETAYSS_star01);
