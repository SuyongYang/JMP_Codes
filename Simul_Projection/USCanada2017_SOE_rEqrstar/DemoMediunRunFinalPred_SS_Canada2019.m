...
% This code generates the steady state for the benchmark model

function flag = DemoMediunRunFinalPred_SS
x0_R = 1.1;
...
TotalPopUS2060 =   170.802; %working age 210 (15-64)
...
yinnovsh = (1-(1-lamy)*omegarr/gN_SS)*stoyw_SS/((1-omegay)*zetay_SS/(1+zetar_SS+zetay_SS));
...
save paramFinalPred_Canada2019 gN_SS rhoyw bbeta ratiodel delta alpha rho varnu gammaI phi Bmega chi ratiodel elasmu phi rhoU gamma omegarr omegay delprime el_SS chiE rhoE lamy yinnovsh shinnovw
save vecSSFinalPred_Canada2019 shareW_SS shareR_SS w_SS k_SS g_SS  gw_SS gE_SS iy_SS tauw_SS Tw_SS ga_SS c_SS y_SS mu_SS rk_SS  U_SS  R_SS lambda_SS el_SS  s_SS za_SS  v_SS  j_SS  varpi_SS b_SS fa_SS PiF_SS Z_SS Epvarsig_SS Ep_SS varsig_SS zetar_SS zetay_SS faw_SS far_SS cr_SS cw_SS hw_SS gm_SS gamma_SS n_SS Dr_SS Dw_SS dr_SS dw_SS PiA_SS inv_SS psi_SS stoyw_SS fert_SS replac_SS
