...
M_.endo_names = cell(126,1);
M_.endo_names_tex = cell(126,1);
M_.endo_names_long = cell(126,1);
M_.endo_names(1) = {'ca'};
...
M_.endo_names(126) = {'AUX_EXO_LAG_66_29'};
M_.endo_names_tex(126) = {'AUX\_EXO\_LAG\_66\_29'};
M_.endo_names_long(126) = {'AUX_EXO_LAG_66_29'};
...
M_.aux_vars(60).endo_index = 126;
M_.aux_vars(60).type = 3;
M_.aux_vars(60).orig_index = 1;
M_.aux_vars(60).orig_lead_lag = -29;
M_.aux_vars(60).orig_expr = 'AUX_EXO_LAG_66_28(-1)';
...
M_.orig_maximum_exo_lag = 30;
M_.orig_maximum_exo_lead = 0;
M_.orig_maximum_exo_det_lag = 0;
M_.orig_maximum_exo_det_lead = 0;
M_.orig_maximum_lag = 30;
M_.orig_maximum_lead = 1;
M_.orig_maximum_lag_with_diffs_expanded = 30;
...
M_.mapping.r.eqidx = [1 2 3 4 5 6 7 8 32 33 34 35 37 38 40 44 50 53 ];
...
M_.mapping.delall.eqidx = [52 53 64 65 66 ];
M_.static_and_dynamic_models_differ = false;
M_.has_external_function = false;
M_.state_var = [1 2 3 6 7 8 9 17 18 26 27 28 29 30 35 36 39 40 41 48 49 52 54 60 61 62 67 68 69 70 71 72 73 74 75 76 77 78 79 80 81 82 83 84 85 86 87 88 89 90 91 92 93 94 95 96 97 98 99 100 101 102 103 104 105 106 107 108 109 110 111 112 113 114 115 116 117 118 119 120 121 122 123 124 125 126 ];
...
M_.params = NaN(158, 1);
M_.endo_trends = struct('deflator', cell(126, 1), 'log_deflator', cell(126, 1), 'growth_factor', cell(126, 1), 'log_growth_factor', cell(126, 1));
M_.NNZDerivatives = [594; -1; -1; ];
...
oo_.steady_state(2) = M_.params(158);
oo_.steady_state(1) = 0;
oo_.steady_state(64) = M_.params(14);
...
oo_.steady_state(43) = M_.params(26);
