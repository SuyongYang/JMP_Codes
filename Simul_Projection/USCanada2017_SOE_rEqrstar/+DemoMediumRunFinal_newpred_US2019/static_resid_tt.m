...
T(1) = (-1);
T(2) = params(3)/(y(1)*y(32))*y(27)/y(26);
...
T(9) = y(53)*T(8);
T(10) = (y(32)*y(1)*params(15))^T(7);
T(11) = (y(25)+1+y(24))^T(1);
T(12) = params(35)+params(36)/2*y(29)^2;
T(13) = y(23)^(T(1)/params(14));
T(14) = y(38)/y(27);
T(15) = y(46)^(1-params(18));
T(16) = y(42)^params(17);
T(17) = (y(26)*y(28))^((1-params(16))*(1-params(17)));
T(18) = y(15)^(-y(37));
T(19) = y(16)^params(7)*params(20);
T(20) = (y(7)/y(57))^params(21);
T(21) = 1-y(47)*params(22)/(y(46)*y(47));
T(22) = params(17)*(1-1/params(18))/y(37);
T(23) = y(27)/y(46);
T(24) = params(22)/y(1);
T(25) = y(43)-y(44)/y(47);
T(26) = y(43)*y(45)+y(44)*(1-y(45))/y(47);
T(27) = 1-1/y(47);
T(28) = (y(38)*y(27)*y(39)/(y(38)*y(39)))^(params(16)*(1-params(17)));
