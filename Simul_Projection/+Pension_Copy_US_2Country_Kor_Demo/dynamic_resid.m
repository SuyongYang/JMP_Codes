...
residual(2) = lhs - rhs;
lhs = y(277);
rhs = y(291)+y(602)*y(598)*y(310)*y(11)/(y(283)*y(259)*y(281));
residual(3) = lhs - rhs;
lhs = y(316);
...
residual(5) = lhs - rhs;
lhs = y(318);
rhs = y(317)+y(11)*y(602)*y(310)*y(605)/(y(283)*y(259)*y(281));
residual(6) = lhs - rhs;
lhs = y(278);
rhs = y(292)+T(2)*y(599)+T(6)*(y(598)+y(605));
residual(7) = lhs - rhs;
lhs = y(269);
...
residual(9) = lhs - rhs;
lhs = 1-y(280)*y(279);
rhs = T(11)*y(280)*y(279)/(y(600)*y(601));
residual(10) = lhs - rhs;
lhs = 1-y(280);
rhs = T(12)/(y(259)*y(288))*y(280)/y(601);
residual(11) = lhs - rhs;
lhs = y(288);
rhs = params(17)+T(3);
residual(12) = lhs - rhs;
...
residual(70) = lhs - rhs;
lhs = y(345);
rhs = y(330)+T(37)*y(609);
residual(71) = lhs - rhs;
lhs = y(344);
rhs = y(340)+T(37)*y(608);
residual(72) = lhs - rhs;
lhs = y(346);
rhs = y(360)+y(614)*y(610)*y(379)*y(40)/(y(352)*y(328)*y(350));
residual(73) = lhs - rhs;
lhs = y(385);
...
residual(75) = lhs - rhs;
lhs = y(387);
rhs = y(386)+y(40)*y(614)*y(379)*y(617)/(y(352)*y(328)*y(350));
residual(76) = lhs - rhs;
lhs = y(347);
rhs = y(361)+T(37)*y(611)+T(41)*(y(610)+y(617));
residual(77) = lhs - rhs;
lhs = y(338);
...
residual(79) = lhs - rhs;
lhs = 1-y(349)*y(348);
rhs = T(46)*y(349)*y(348)/(y(612)*y(613));
residual(80) = lhs - rhs;
lhs = 1-y(349);
rhs = T(47)/(y(328)*y(357))*y(349)/y(613);
residual(81) = lhs - rhs;
lhs = y(357);
rhs = params(176)+T(38);
residual(82) = lhs - rhs;
...
rhs = params(163)/(1+params(162)+params(163))+y(391);
