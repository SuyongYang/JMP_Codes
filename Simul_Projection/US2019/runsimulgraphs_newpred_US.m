...
load EconData.csv;
flag = vecpos(1);
%index = {'Upper95', 'Upper80', 'Median', 'Lower80', 'Lower95'};
index = {'Upper99', 'Upper84', 'Median', 'Lower84', 'Lower99'};
...
country_flag  = eval(append('parampredic_US2019_', tempIndex, '(flag);'))
...
legend(p1,{string(index(1)),string(index(2)),string(index(3)),string(index(4)),string(index(5))},'Location','southwest')
legend(p2,{string(index(1)),string(index(2)),string(index(3)),string(index(4)),string(index(5))},'Location','best')
