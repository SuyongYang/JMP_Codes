...
var r, rk,  w, b,  y, varpi, s, inv,c, cw, cwper, cr, crper, tauw, N, stoyw, PiF,Tw,  hw, Dr, Dw,  ep, varsig, zetar, zetay, gw, g, gE, iy, gpc, gy, zz, far, faw, dr, dw,  mu, k, u, del, delprime, gM,   v, j,  lam, gA, za, PiA, PiRD,  fa, n , gn, gamma, er, ey, en, psi, shockr, shocky, shockn, fert, omegay, shareW, shareR;
varexo delall;
...
stoyw = YINNOVSH*(1-omegay)*zetay(-1)/(1+zetay(-1)+zetar(-1)) 
+ ((1-LAMY)*OMEGAR/gn)*stoyw(-1); % intersity to transform inverted goods into adopted goods
