...
var shockR,path, fee,ca, rstar, r, rk,  w, b,  y, varpi, s, inv,c, cw, cwper, cr, crper, tauw, N, stoyw, PiF,Tw,  hw, Dr, Dw,  ep, varsig, zetar, zetay, gw, g, gE, iy, gpc, gy, zz, far, faw, dr, dw,  mu, k, u, del, delprime, gM,   v, j,  lam, gA, za, PiA, PiRD,  fa, n , gn, gamma, er, ey, en, psi, shockr, shocky, shockn, fert, omegay, shareW, shareR;
varexo delall;
...
path = r+delall*(rstar-r)+delall(-1)*(rstar-r)+delall(-2)*(rstar-r)+delall(-3)*(rstar-r)+delall(-4)*(rstar-r)+delall(-5)*(rstar-r)+delall(-6)*(rstar-r)+delall(-7)*(rstar-r)+delall(-8)*(rstar-r)+delall(-9)*(rstar-r)+delall(-10)*(rstar-r) ;
%path= R_SS + delall*(Rstar_SS-R_SS+Rh_1)+	delall(-1)*(Rstar_SS-R_SS+Rh_2)+	delall(-2)*(Rstar_SS-R_SS+Rh_3)+	delall(-3)*(Rstar_SS-R_SS+Rh_4)+	delall(-4)*(Rstar_SS-R_SS+Rh_5)+	delall(-5)*(Rstar_SS-R_SS+Rh_6)+	delall(-6)*(Rstar_SS-R_SS+Rh_7)+	delall(-7)*(Rstar_SS-R_SS+Rh_8)+	delall(-8)*(Rstar_SS-R_SS+Rh_9)+	delall(-9)*(Rstar_SS-R_SS+Rh_10)+	delall(-10)*(Rstar_SS-R_SS+Rh_11)+	delall(-11)*(Rstar_SS-R_SS+Rh_12)+	delall(-12)*(Rstar_SS-R_SS+Rh_13)+	delall(-13)*(Rstar_SS-R_SS+Rh_14)+	delall(-14)*(Rstar_SS-R_SS+Rh_15)+	delall(-15)*(Rstar_SS-R_SS+Rh_16)+	delall(-16)*(Rstar_SS-R_SS+Rh_17)+	delall(-17)*(Rstar_SS-R_SS+Rh_18)+	delall(-18)*(Rstar_SS-R_SS+Rh_19)+	delall(-19)*(Rstar_SS-R_SS+Rh_20)+	delall(-20)*(Rstar_SS-R_SS+Rh_21)+	delall(-21)*(Rstar_SS-R_SS+Rh_22)+	delall(-22)*(Rstar_SS-R_SS+Rh_23)+	delall(-23)*(Rstar_SS-R_SS+Rh_24)+	delall(-24)*(Rstar_SS-R_SS+Rh_25)+	delall(-25)*(Rstar_SS-R_SS+Rh_26)+	delall(-26)*(Rstar_SS-R_SS+Rh_27)+	delall(-27)*(Rstar_SS-R_SS+Rh_28)+	delall(-28)*(Rstar_SS-R_SS+Rh_29)+	delall(-29)*(Rstar_SS-R_SS+Rh_30);
(rk(+1)+1) = path; %ex ante rate of return
...
%r(1)-rstar(1)-(R_SS-Rstar_SS)=0.3*(r-rstar-(R_SS-Rstar_SS));
%not working
%r=R_SS + delall*(0.1*(ca-ca(-1))+ rstar-R_SS);
% not working
%r(1)/rstar(1)=r/rstar;
% good!
%r(1)-rstar(1)=r-rstar;
...
0 = (rk(1) + 1)*(k/g(1)) + b*r/g(1) + ca*rstar/g(1) - fa*r/g(1)  ;
%working but...
%0 = rstar*(k/g(1)) + b*rstar/g(1) + ca*rstar/g(1) - fa*rstar/g(1)  ;
% not working
%0 = rstar*(k/g(1)) + b*r/g(1) + ca*rstar/g(1) - fa*rstar/g(1)  ;
% not working
%0 = (rk(1) + 1)*(k/g(1)) + b*r/g(1) + ca*rstar/g(1) - fa*rstar/g(1)  ;
% not working
%0 = (rk(1) + 1)*(k/g(1)) + b*rstar/g(1) + ca*rstar/g(1) - fa*r/g(1)  ;
% not working
%0 = (rk(1) + 1)*(k/g(1)) + b*rstar/g(1) + ca*r/g(1) - fa*r/g(1)  ;
%not working

%exp(r(1)-rstar(1))=exp(r-rstar);
%working
%path = (r-rstar);
%r = 0.1*(ca-ca(-1)) + rstar + R_SS - Rstar_SS;
