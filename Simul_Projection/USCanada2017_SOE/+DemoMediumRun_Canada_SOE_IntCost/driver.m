...
options_ = [];
M_.fname = 'DemoMediumRun_Canada_SOE_IntCost';
...
diary off;
diary('DemoMediumRun_Canada_SOE_IntCost.log');
...
M_.endo_names(1) = {'path'};
M_.endo_names_tex(1) = {'path'};
M_.endo_names_long(1) = {'path'};
M_.endo_names(2) = {'pathA'};
M_.endo_names_tex(2) = {'pathA'};
M_.endo_names_long(2) = {'pathA'};
M_.endo_names(3) = {'fee'};
...
M_.param_names(1) = {'Rstar_SS'};
M_.param_names_tex(1) = {'Rstar\_SS'};
M_.param_names_long(1) = {'Rstar_SS'};
M_.param_names(2) = {'R_SS'};
M_.param_names_tex(2) = {'R\_SS'};
M_.param_names_long(2) = {'R_SS'};
...
M_.param_names(5) = {'OMEGAR'};
M_.param_names_tex(5) = {'OMEGAR'};
M_.param_names_long(5) = {'OMEGAR'};
M_.param_names(6) = {'ZETAYSS'};
M_.param_names_tex(6) = {'ZETAYSS'};
M_.param_names_long(6) = {'ZETAYSS'};
M_.param_names(7) = {'ZETARSS'};
M_.param_names_tex(7) = {'ZETARSS'};
M_.param_names_long(7) = {'ZETARSS'};
M_.param_names(8) = {'REPLACSS'};
M_.param_names_tex(8) = {'REPLACSS'};
M_.param_names_long(8) = {'REPLACSS'};
...
M_.param_names(15) = {'OMEGAYSS'};
M_.param_names_tex(15) = {'OMEGAYSS'};
M_.param_names_long(15) = {'OMEGAYSS'};
...
M_.param_names(39) = {'gn_1'};
M_.param_names_tex(39) = {'gn\_1'};
M_.param_names_long(39) = {'gn_1'};
M_.param_names(40) = {'gn_2'};
M_.param_names_tex(40) = {'gn\_2'};
M_.param_names_long(40) = {'gn_2'};
M_.param_names(41) = {'gn_3'};
M_.param_names_tex(41) = {'gn\_3'};
M_.param_names_long(41) = {'gn_3'};
M_.param_names(42) = {'gn_4'};
M_.param_names_tex(42) = {'gn\_4'};
M_.param_names_long(42) = {'gn_4'};
M_.param_names(43) = {'gn_5'};
M_.param_names_tex(43) = {'gn\_5'};
M_.param_names_long(43) = {'gn_5'};
M_.param_names(44) = {'gn_6'};
M_.param_names_tex(44) = {'gn\_6'};
M_.param_names_long(44) = {'gn_6'};
M_.param_names(45) = {'gn_7'};
M_.param_names_tex(45) = {'gn\_7'};
M_.param_names_long(45) = {'gn_7'};
M_.param_names(46) = {'gn_8'};
M_.param_names_tex(46) = {'gn\_8'};
M_.param_names_long(46) = {'gn_8'};
M_.param_names(47) = {'gn_9'};
M_.param_names_tex(47) = {'gn\_9'};
M_.param_names_long(47) = {'gn_9'};
M_.param_names(48) = {'gn_10'};
M_.param_names_tex(48) = {'gn\_10'};
M_.param_names_long(48) = {'gn_10'};
M_.param_names(49) = {'gn_11'};
M_.param_names_tex(49) = {'gn\_11'};
M_.param_names_long(49) = {'gn_11'};
M_.param_names(50) = {'gn_12'};
M_.param_names_tex(50) = {'gn\_12'};
M_.param_names_long(50) = {'gn_12'};
M_.param_names(51) = {'gn_13'};
M_.param_names_tex(51) = {'gn\_13'};
M_.param_names_long(51) = {'gn_13'};
M_.param_names(52) = {'gn_14'};
M_.param_names_tex(52) = {'gn\_14'};
M_.param_names_long(52) = {'gn_14'};
M_.param_names(53) = {'gn_15'};
M_.param_names_tex(53) = {'gn\_15'};
M_.param_names_long(53) = {'gn_15'};
M_.param_names(54) = {'gn_16'};
M_.param_names_tex(54) = {'gn\_16'};
M_.param_names_long(54) = {'gn_16'};
M_.param_names(55) = {'gn_17'};
M_.param_names_tex(55) = {'gn\_17'};
M_.param_names_long(55) = {'gn_17'};
M_.param_names(56) = {'gn_18'};
M_.param_names_tex(56) = {'gn\_18'};
M_.param_names_long(56) = {'gn_18'};
M_.param_names(57) = {'gn_19'};
M_.param_names_tex(57) = {'gn\_19'};
M_.param_names_long(57) = {'gn_19'};
M_.param_names(58) = {'gn_20'};
M_.param_names_tex(58) = {'gn\_20'};
M_.param_names_long(58) = {'gn_20'};
M_.param_names(59) = {'gn_21'};
M_.param_names_tex(59) = {'gn\_21'};
M_.param_names_long(59) = {'gn_21'};
M_.param_names(60) = {'gn_22'};
M_.param_names_tex(60) = {'gn\_22'};
M_.param_names_long(60) = {'gn_22'};
M_.param_names(61) = {'gn_23'};
M_.param_names_tex(61) = {'gn\_23'};
M_.param_names_long(61) = {'gn_23'};
M_.param_names(62) = {'gn_24'};
M_.param_names_tex(62) = {'gn\_24'};
M_.param_names_long(62) = {'gn_24'};
M_.param_names(63) = {'gn_25'};
M_.param_names_tex(63) = {'gn\_25'};
M_.param_names_long(63) = {'gn_25'};
M_.param_names(64) = {'gn_26'};
M_.param_names_tex(64) = {'gn\_26'};
M_.param_names_long(64) = {'gn_26'};
M_.param_names(65) = {'gn_27'};
M_.param_names_tex(65) = {'gn\_27'};
M_.param_names_long(65) = {'gn_27'};
M_.param_names(66) = {'gn_28'};
M_.param_names_tex(66) = {'gn\_28'};
M_.param_names_long(66) = {'gn_28'};
M_.param_names(67) = {'gn_29'};
M_.param_names_tex(67) = {'gn\_29'};
M_.param_names_long(67) = {'gn_29'};
M_.param_names(68) = {'gn_30'};
M_.param_names_tex(68) = {'gn\_30'};
M_.param_names_long(68) = {'gn_30'};
...
M_.param_names(99) = {'drs_1'};
M_.param_names_tex(99) = {'drs\_1'};
M_.param_names_long(99) = {'drs_1'};
M_.param_names(100) = {'drs_2'};
M_.param_names_tex(100) = {'drs\_2'};
M_.param_names_long(100) = {'drs_2'};
M_.param_names(101) = {'drs_3'};
M_.param_names_tex(101) = {'drs\_3'};
M_.param_names_long(101) = {'drs_3'};
M_.param_names(102) = {'drs_4'};
M_.param_names_tex(102) = {'drs\_4'};
M_.param_names_long(102) = {'drs_4'};
M_.param_names(103) = {'drs_5'};
M_.param_names_tex(103) = {'drs\_5'};
M_.param_names_long(103) = {'drs_5'};
M_.param_names(104) = {'drs_6'};
M_.param_names_tex(104) = {'drs\_6'};
M_.param_names_long(104) = {'drs_6'};
M_.param_names(105) = {'drs_7'};
M_.param_names_tex(105) = {'drs\_7'};
M_.param_names_long(105) = {'drs_7'};
M_.param_names(106) = {'drs_8'};
M_.param_names_tex(106) = {'drs\_8'};
M_.param_names_long(106) = {'drs_8'};
M_.param_names(107) = {'drs_9'};
M_.param_names_tex(107) = {'drs\_9'};
M_.param_names_long(107) = {'drs_9'};
M_.param_names(108) = {'drs_10'};
M_.param_names_tex(108) = {'drs\_10'};
M_.param_names_long(108) = {'drs_10'};
M_.param_names(109) = {'drs_11'};
M_.param_names_tex(109) = {'drs\_11'};
M_.param_names_long(109) = {'drs_11'};
M_.param_names(110) = {'drs_12'};
M_.param_names_tex(110) = {'drs\_12'};
M_.param_names_long(110) = {'drs_12'};
M_.param_names(111) = {'drs_13'};
M_.param_names_tex(111) = {'drs\_13'};
M_.param_names_long(111) = {'drs_13'};
M_.param_names(112) = {'drs_14'};
M_.param_names_tex(112) = {'drs\_14'};
M_.param_names_long(112) = {'drs_14'};
M_.param_names(113) = {'drs_15'};
M_.param_names_tex(113) = {'drs\_15'};
M_.param_names_long(113) = {'drs_15'};
M_.param_names(114) = {'drs_16'};
M_.param_names_tex(114) = {'drs\_16'};
M_.param_names_long(114) = {'drs_16'};
M_.param_names(115) = {'drs_17'};
M_.param_names_tex(115) = {'drs\_17'};
M_.param_names_long(115) = {'drs_17'};
M_.param_names(116) = {'drs_18'};
M_.param_names_tex(116) = {'drs\_18'};
M_.param_names_long(116) = {'drs_18'};
M_.param_names(117) = {'drs_19'};
M_.param_names_tex(117) = {'drs\_19'};
M_.param_names_long(117) = {'drs_19'};
M_.param_names(118) = {'drs_20'};
M_.param_names_tex(118) = {'drs\_20'};
M_.param_names_long(118) = {'drs_20'};
M_.param_names(119) = {'drs_21'};
M_.param_names_tex(119) = {'drs\_21'};
M_.param_names_long(119) = {'drs_21'};
M_.param_names(120) = {'drs_22'};
M_.param_names_tex(120) = {'drs\_22'};
M_.param_names_long(120) = {'drs_22'};
M_.param_names(121) = {'drs_23'};
M_.param_names_tex(121) = {'drs\_23'};
M_.param_names_long(121) = {'drs_23'};
M_.param_names(122) = {'drs_24'};
M_.param_names_tex(122) = {'drs\_24'};
M_.param_names_long(122) = {'drs_24'};
M_.param_names(123) = {'drs_25'};
M_.param_names_tex(123) = {'drs\_25'};
M_.param_names_long(123) = {'drs_25'};
M_.param_names(124) = {'drs_26'};
M_.param_names_tex(124) = {'drs\_26'};
M_.param_names_long(124) = {'drs_26'};
M_.param_names(125) = {'drs_27'};
M_.param_names_tex(125) = {'drs\_27'};
M_.param_names_long(125) = {'drs_27'};
M_.param_names(126) = {'drs_28'};
M_.param_names_tex(126) = {'drs\_28'};
M_.param_names_long(126) = {'drs_28'};
M_.param_names(127) = {'drs_29'};
M_.param_names_tex(127) = {'drs\_29'};
M_.param_names_long(127) = {'drs_29'};
M_.param_names(128) = {'drs_30'};
M_.param_names_tex(128) = {'drs\_30'};
M_.param_names_long(128) = {'drs_30'};
M_.param_names(129) = {'Rh_1'};
M_.param_names_tex(129) = {'Rh\_1'};
M_.param_names_long(129) = {'Rh_1'};
M_.param_names(130) = {'Rh_2'};
M_.param_names_tex(130) = {'Rh\_2'};
M_.param_names_long(130) = {'Rh_2'};
M_.param_names(131) = {'Rh_3'};
M_.param_names_tex(131) = {'Rh\_3'};
M_.param_names_long(131) = {'Rh_3'};
M_.param_names(132) = {'Rh_4'};
M_.param_names_tex(132) = {'Rh\_4'};
M_.param_names_long(132) = {'Rh_4'};
M_.param_names(133) = {'Rh_5'};
M_.param_names_tex(133) = {'Rh\_5'};
M_.param_names_long(133) = {'Rh_5'};
M_.param_names(134) = {'Rh_6'};
M_.param_names_tex(134) = {'Rh\_6'};
M_.param_names_long(134) = {'Rh_6'};
M_.param_names(135) = {'Rh_7'};
M_.param_names_tex(135) = {'Rh\_7'};
M_.param_names_long(135) = {'Rh_7'};
M_.param_names(136) = {'Rh_8'};
M_.param_names_tex(136) = {'Rh\_8'};
M_.param_names_long(136) = {'Rh_8'};
M_.param_names(137) = {'Rh_9'};
M_.param_names_tex(137) = {'Rh\_9'};
M_.param_names_long(137) = {'Rh_9'};
M_.param_names(138) = {'Rh_10'};
M_.param_names_tex(138) = {'Rh\_10'};
M_.param_names_long(138) = {'Rh_10'};
M_.param_names(139) = {'Rh_11'};
M_.param_names_tex(139) = {'Rh\_11'};
M_.param_names_long(139) = {'Rh_11'};
M_.param_names(140) = {'Rh_12'};
M_.param_names_tex(140) = {'Rh\_12'};
M_.param_names_long(140) = {'Rh_12'};
M_.param_names(141) = {'Rh_13'};
M_.param_names_tex(141) = {'Rh\_13'};
M_.param_names_long(141) = {'Rh_13'};
M_.param_names(142) = {'Rh_14'};
M_.param_names_tex(142) = {'Rh\_14'};
M_.param_names_long(142) = {'Rh_14'};
M_.param_names(143) = {'Rh_15'};
M_.param_names_tex(143) = {'Rh\_15'};
M_.param_names_long(143) = {'Rh_15'};
M_.param_names(144) = {'Rh_16'};
M_.param_names_tex(144) = {'Rh\_16'};
M_.param_names_long(144) = {'Rh_16'};
M_.param_names(145) = {'Rh_17'};
M_.param_names_tex(145) = {'Rh\_17'};
M_.param_names_long(145) = {'Rh_17'};
M_.param_names(146) = {'Rh_18'};
M_.param_names_tex(146) = {'Rh\_18'};
M_.param_names_long(146) = {'Rh_18'};
M_.param_names(147) = {'Rh_19'};
M_.param_names_tex(147) = {'Rh\_19'};
M_.param_names_long(147) = {'Rh_19'};
M_.param_names(148) = {'Rh_20'};
M_.param_names_tex(148) = {'Rh\_20'};
M_.param_names_long(148) = {'Rh_20'};
M_.param_names(149) = {'Rh_21'};
M_.param_names_tex(149) = {'Rh\_21'};
M_.param_names_long(149) = {'Rh_21'};
M_.param_names(150) = {'Rh_22'};
M_.param_names_tex(150) = {'Rh\_22'};
M_.param_names_long(150) = {'Rh_22'};
M_.param_names(151) = {'Rh_23'};
M_.param_names_tex(151) = {'Rh\_23'};
M_.param_names_long(151) = {'Rh_23'};
M_.param_names(152) = {'Rh_24'};
M_.param_names_tex(152) = {'Rh\_24'};
M_.param_names_long(152) = {'Rh_24'};
M_.param_names(153) = {'Rh_25'};
M_.param_names_tex(153) = {'Rh\_25'};
M_.param_names_long(153) = {'Rh_25'};
M_.param_names(154) = {'Rh_26'};
M_.param_names_tex(154) = {'Rh\_26'};
M_.param_names_long(154) = {'Rh_26'};
M_.param_names(155) = {'Rh_27'};
M_.param_names_tex(155) = {'Rh\_27'};
M_.param_names_long(155) = {'Rh_27'};
M_.param_names(156) = {'Rh_28'};
M_.param_names_tex(156) = {'Rh\_28'};
M_.param_names_long(156) = {'Rh_28'};
M_.param_names(157) = {'Rh_29'};
M_.param_names_tex(157) = {'Rh\_29'};
M_.param_names_long(157) = {'Rh_29'};
M_.param_names(158) = {'Rh_30'};
M_.param_names_tex(158) = {'Rh\_30'};
M_.param_names_long(158) = {'Rh_30'};
...
M_.mapping.path.eqidx = [54 ];
M_.mapping.pathA.eqidx = [55 ];
M_.mapping.fee.eqidx = [44 53 55 ];
M_.mapping.ca.eqidx = [44 47 49 54 55 ];
M_.mapping.rstar.eqidx = [44 52 53 56 ];
M_.mapping.r.eqidx = [1 2 3 4 5 6 7 8 32 33 34 35 37 38 40 44 50 52 53 ];
M_.mapping.rk.eqidx = [21 40 44 ];
M_.mapping.w.eqidx = [1 17 18 20 50 ];
M_.mapping.b.eqidx = [43 44 49 ];
M_.mapping.y.eqidx = [46 47 57 58 ];
...
M_.mapping.g.eqidx = [1 2 3 4 5 6 18 21 22 23 24 32 33 34 35 37 38 44 45 50 55 57 58 ];
...
M_.mapping.delall.eqidx = [56 67 68 69 ];
M_.static_and_dynamic_models_differ = false;
M_.has_external_function = false;
M_.state_var = [3 4 5 6 9 10 11 12 20 21 29 30 31 32 33 38 39 42 43 44 51 52 55 57 63 64 65 70 71 72 73 74 75 76 77 78 79 80 81 82 83 84 85 86 87 88 89 90 91 92 93 94 95 96 97 98 99 100 101 102 103 104 105 106 107 108 109 110 111 112 113 114 115 116 117 118 119 120 121 122 123 124 125 126 127 128 ];
...
load RstarShocks;
M_.params(1) = 1.012702410925000;
Rstar_SS = M_.params(1);
...
oo_.steady_state(3) = M_.params(2)-M_.params(1);
oo_.steady_state(6) = M_.params(2);
oo_.steady_state(5) = M_.params(1);
oo_.steady_state(4) = 0;
oo_.steady_state(67) = M_.params(15);
...
oo_.steady_state(46) = M_.params(27);
...
save('DemoMediumRun_Canada_SOE_IntCost_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('DemoMediumRun_Canada_SOE_IntCost_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('DemoMediumRun_Canada_SOE_IntCost_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('DemoMediumRun_Canada_SOE_IntCost_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('DemoMediumRun_Canada_SOE_IntCost_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('DemoMediumRun_Canada_SOE_IntCost_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('DemoMediumRun_Canada_SOE_IntCost_results.mat', 'oo_recursive_', '-append');
end
