...
options_ = [];
M_.fname = 'DemoMediumRunFinal_pop_pension_Kor';
...
diary off;
diary('DemoMediumRunFinal_pop_pension_Kor.log');
...
save('DemoMediumRunFinal_pop_pension_Kor_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('DemoMediumRunFinal_pop_pension_Kor_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('DemoMediumRunFinal_pop_pension_Kor_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('DemoMediumRunFinal_pop_pension_Kor_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('DemoMediumRunFinal_pop_pension_Kor_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('DemoMediumRunFinal_pop_pension_Kor_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('DemoMediumRunFinal_pop_pension_Kor_results.mat', 'oo_recursive_', '-append');
end
